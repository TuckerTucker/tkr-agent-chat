...
export const MarkdownRenderer: FC<MarkdownRendererProps> = ({
  ...
  // Message processing now handled by the built-in highlightMentions function
  
  // We now use ReactMarkdown for rendering, this manual markdown parser is removed
  
  // Mentions are now rendered using HTML injected into the markdown
